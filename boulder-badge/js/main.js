...
function fahrenheitToCelsius(degreesC){
    return (degreesC - 32) * 5/9
}

const canCharmanderFight = degreesC => {
    if(degreesC > 0 || fahrenheitToCelsius() > 32){
        console.log('Charmander can fight!')
    }else{
        console.log('Charmander is too weak to fight!')
    }
}

canCharmanderFight(fahrenheitToCelsius(32.1))
// canCharmanderFight(1)
